...
- Added an isolated `src/figure_pipeline/` package; Track A OCR behavior remains
  unchanged.
...
- Added a CLI at `scripts/phase_b1_figure_asset.py`.
...
- Source document: `data/sources/2015p2.pdf`
- Question: `hk-dse-2015-math-p2-q018`
- Page: `6`
- Upstream question crop:
  `data/pdf_pages/2015p2/crops/p006_q018.png`
...
- Proposal:
  `output/figure_pipeline/2015p2/q018-proposal/proposal.json`
- Final asset JSON:
  `output/figure_pipeline/2015p2/q018/figure_asset.json`
- Preserved question crop:
  `output/figure_pipeline/2015p2/q018/question.png`
- Figure crop:
  `output/figure_pipeline/2015p2/q018/assets/q018_fig01.png`
...
- uv run python scripts/phase_b2_figure_classify.py propose --asset <b1-bundle> --out <b2-bundle>
- uv run python scripts/phase_b2_figure_classify.py review --asset <pending-or-failed-b2> --out <reviewed-b2> --reviewer <name> --status approved|corrected|rejected
...
Real local Qwen smoke: output/figure_pipeline/2015p2/q018-b2 was published as
...
`output/figure_pipeline/2015p2/q018-b2-reviewed` as a corrected
...
- `uv run python scripts/phase_b3_visible_labels.py propose --asset <b2-bundle> --out <b3-bundle>`
- `uv run python scripts/phase_b3_visible_labels.py review --asset <pending-or-failed-b3> --out <reviewed-b3> --reviewer <name> --status approved|corrected|rejected [--labels-json <corrected-labels.json>]`
...
GPU, `output/figure_pipeline/2015p2/q018-b3` was published as a valid
...
`output/figure_pipeline/2015p2/q018-b3-reviewed` with labels
...
`output/figure_pipeline/benchmark/benchmark-manifest.json`; the
report is
...
`output/figure_pipeline/benchmark/b3-prompt-comparison.json`.
...
`output/figure_pipeline/benchmark/benchmark-manifest-v2.json` and
the machine-readable result is
`output/figure_pipeline/benchmark/holdout-comparison-2026-08-07.json`.
...
`output/figure_pipeline/benchmark/b3-sequence-order-v1.json`;
report:
