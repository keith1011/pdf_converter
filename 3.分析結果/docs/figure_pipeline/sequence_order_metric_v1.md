...
```powershell
uv run python scripts/evaluate_b3_sequence_order.py `
  --gold 3.分析結果/evals/figure_pipeline/b3_sequence_order_gold_v1.json `
  --benchmark-root output/figure_pipeline/benchmark `
  --out output/figure_pipeline/benchmark/b3-sequence-order-v1.json
```
