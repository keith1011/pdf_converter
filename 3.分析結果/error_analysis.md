...
| Source | Traces | Notes |
|--------|--------|-------|
| `golden_run_full2.log` + `output/123.tex` + `data/pdf_pages/123/page_*.png` | **14 page-level** | One full marking-scheme PDF |
...
C1 依據：`output/123.tex` 該頁切片是否含「將圖片…」／Markdown 變體。  
