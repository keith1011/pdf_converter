...
Next step: extend the holdout with more varied/non-geometry figures and define
a separate sequence-order metric. If that remains green, design B4 structured
