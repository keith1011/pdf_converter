...
```text
output/figure_pipeline/<document>/q<question>/assets/q<question>_figNN.png
```
...
```powershell
uv run python scripts/phase_b2_figure_classify.py propose `
  --asset output/figure_pipeline/2015p2/q018 `
  --out output/figure_pipeline/2015p2/q018-b2
```
