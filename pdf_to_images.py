...
Usage:
  ..\\AIbuliding\\venv-train\\Scripts\\python.exe pdf_to_images.py data/sources/paper.pdf
  ..\\AIbuliding\\venv-train\\Scripts\\python.exe pdf_to_images.py data/sources/paper.pdf --dpi 200
"""
